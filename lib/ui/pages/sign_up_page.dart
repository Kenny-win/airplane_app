...
class SignUpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget inputSection() {
      Widget nameInput() => CustomTextFormField(title: 'Full Name', hintText: 'Your full name', controller: nameController,);
      ...
      Widget hobbyInput() => CustomTextFormField(title: 'Hobby', hintText: 'Your hobby', controller: hobbyController,);
